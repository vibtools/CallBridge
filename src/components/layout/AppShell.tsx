...
const titles: Record<AppPage, string> = { overview: "Overview", live: "Live Calls", incoming: "Incoming Calls", cdr: "Call History", voicemail: "Voicemail", queues: "Queues", "ring-groups": "Ring Groups", ivr: "IVR / Auto Attendant", agents: "Agents", extensions: "Extensions", phonebook: "Phonebook", did: "DID Numbers", "settings-did": "DID Settings", analytics: "Analytics & Reports", settings: "Settings", "settings-agents": "Agent Settings", "settings-queues": "Queue Settings" }
